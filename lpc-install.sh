...
CONFIG_FILE='megabytecoin.conf'
CONFIGFOLDER='/root/.megabytecoin'
COIN_DAEMON='/usr/local/bin/megabytecoind'
COIN_CLI='/usr/local/bin/megabytecoin-cli'
COIN_REPO='https://github.com/mgbytecoin/mgbcoin/releases/download/1/megabytecoin.tar.gz'
COIN_NAME='MegaByteCoin'
COIN_PORT=19662
